/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c6a52df91729782b28fabeffd73f483e)
// Runtime types generated with workerd@1.20260603.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
	ASSETS: R2Bucket;
	DB: D1Database;
	DocDO: DurableObjectNamespace<import("./src/server").DocDO>;
	HtmlDocDO: DurableObjectNamespace<import("./src/server").HtmlDocDO>;
	SearchDO: DurableObjectNamespace<import("./src/server").SearchDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server");
		durableNamespaces: "DocDO" | "SearchDO" | "HtmlDocDO";
	}
